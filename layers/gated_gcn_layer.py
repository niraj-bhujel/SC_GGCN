...
class GatedGCNLayerConv(nn.Module):
    """
        Param: []
    """
    def __init__(self, input_dim, output_dim, dropout=0.0, batch_norm=False, residual=False):
        super().__init__()
        ...
        self.A = nn.Conv1d(input_dim, output_dim, 1, bias=True)
        self.B = nn.Conv1d(input_dim, output_dim, 1, bias=True)  
        self.C = nn.Conv1d(input_dim, output_dim, 1, bias=True)
        self.D = nn.Conv1d(input_dim, output_dim, 1, bias=True)
        self.E = nn.Conv1d(input_dim, output_dim, 1, bias=True)
